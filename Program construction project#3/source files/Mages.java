public class Mages extends Army{
    private Armour armour = null;
    private Artefacts artefact =null;
    private int Armour_count = 0;
    private int Artefacts_count = 0;
    public Mages(String name, int price, int attack, int defence, int health, int speed) {
